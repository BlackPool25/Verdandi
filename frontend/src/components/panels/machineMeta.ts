...
export const MACHINE_META: Readonly<Record<string, MachineMeta>> = {
  ...
  A3: { cls: "process", base: 70.0, sigma: 1.5, cycle: 6, mttf: 800, mttr: 20, bufferCap: 25 },
  A4: { cls: "process", base: 70.0, sigma: 1.5, cycle: 6, mttf: 800, mttr: 20, bufferCap: 25 },
  A5: { cls: "process", base: 70.0, sigma: 1.5, cycle: 6, mttf: 800, mttr: 20, bufferCap: 25 },
  A6: { cls: "process", base: 70.0, sigma: 1.5, cycle: 6, mttf: 800, mttr: 20, bufferCap: 25 },
  ...
  B3: { cls: "process", base: 70.0, sigma: 1.5, cycle: 6, mttf: 800, mttr: 20, bufferCap: 25 },
  B4: { cls: "process", base: 70.0, sigma: 1.5, cycle: 6, mttf: 800, mttr: 20, bufferCap: 25 },
  B5: { cls: "process", base: 70.0, sigma: 1.5, cycle: 6, mttf: 800, mttr: 20, bufferCap: 25 },
  B6: { cls: "process", base: 70.0, sigma: 1.5, cycle: 6, mttf: 800, mttr: 20, bufferCap: 25 },
  B7: { cls: "process", base: 70.0, sigma: 1.5, cycle: 6, mttf: 800, mttr: 20, bufferCap: 25 },
  ...
  C3: { cls: "process", base: 70.0, sigma: 1.5, cycle: 6, mttf: 800, mttr: 20, bufferCap: 25 },
  C4: { cls: "process", base: 70.0, sigma: 1.5, cycle: 6, mttf: 800, mttr: 20, bufferCap: 25 },
  C5: { cls: "process", base: 70.0, sigma: 1.5, cycle: 6, mttf: 800, mttr: 20, bufferCap: 25 },
...
export const TAILS: readonly string[] = ["A9", "B9", "C7"];
